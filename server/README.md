...
Скрипты для управления ключами и идентификации меток по принятым `iBeacon`-пакетам.
...
- ключ прошивается в каждый `STM32L031` при производстве через зашифрованный канал или в защищённом помещении.
