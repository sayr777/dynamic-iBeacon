...
### AK-45 (IP54, 58×30×22 мм) — вариант для помещений

| Параметр | Значение |
|---|---|
| Размер (Д×Ш×В) | 58 × 30 × 22 мм |
| Материал | ABS пластик |
| Степень защиты | IP54 |
| Цвет | на заказ (уточнять при заказе) |
| Серия | AK-1,2… (под LED) |
| Вес | 9 г |
| Цена (розн.) | 81.2 ₽ |
| Цена (от 31 шт) | 45.1 ₽ |

**Покупка:**
- [myszomk.ru — AK-45](https://myszomk.ru/product/ak-45)

---

### AK-W-42 (IP54, 51×36×20 мм) — настенный вариант

| Параметр | Значение |
|---|---|
| Размер (Д×Ш×В) | 51 × 36 × 20 мм |
| Внутренний размер | 44 × 30 × 12.7 мм |
| Материал | ABS пластик |
| Степень защиты | IP54 |
| Цвет | светло-серый / чёрный (от 1000 шт — любой) |
| Крепление | крепёжные ушки |
| Вес | 15 г |
| Цена (розн.) | 221.8 ₽ |
| Цена (от 31 шт) | 123.2 ₽ |

**Покупка:**
- [myszomk.ru — AK-W-42](https://myszomk.ru/product/ak-w-42)
